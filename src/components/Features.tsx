function Features() {
  return (
    <>
      ...
      <div className="relative features flex   md:flex-row flex-col">
        <div
          // data-aos="fade-left"
        ...
        <div className="flex flex-col  mt-16 items-center lg:justify-start justify-center lg:w-1/3 hover:scale-105 hover:shadow-lightBlueShadow rounded-3xl transition-all p-5">
          ...
          <p className="mt-5  w-full text-gray-400 text-center">
            Completely get rid of Windows defender, With malwarebytes
            PreInstalled{" "}
          </p>
        </div>
        {/* <div className="flex flex-col mt-16  items-center lg:justify-start justify-center lg:w-1/4 hover:scale-105 hover:shadow-lightBlueShadow rounded-3xl transition-all p-5">
          ...
          <h2 className="text-lg font-semibold">personalize your device</h2>
        ...
        >
          <div
            className="aspect-[955/1078] w-[60rem] bg-gradient-to-l from-sky-600 to-purple-500 opacity-40 blur-3xl"
            style={{
              clipPath:
