        ...
        <nav className=''>
            <div className=" sm:px-8 px-3 sm:py-2 py-5 flex absolute top-0  justify-between items-center w-full ring-1 ring-cyan-900  bg-gray-950 bg-opacity-50 ">
                ...
                <div className="flex items-center">
                    <img src={logo} alt="logo" className="inline ml-2 h-6 mt-1 sm:h-8 sm:mt-0 rounded text-white"/>
                    <p className="text-white ml-4 font-bold text-xl">ChlorideOS</p>
                </div>
                {/* download button */}
                <div className='flex items-center'>
                    {/* <button>Premium</button> */}
                    <a href="https://chat.whatsapp.com/EzDfW89EQt90yFHXTZFI2R" target='_blank'><FontAwesomeIcon icon={faUsers} size='lg' className='mr-5 hover:text-blue-200  transition-all cursor-pointer'/></a>
