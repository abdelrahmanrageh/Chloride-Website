...
import { gridData, versions, versionsNames } from "../../data/versionsData";
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {gridData.map((data, index) => (
              <m.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1, delay: 0.2 }}
                className="bg-gray-950 flex flex-col w-full justify-between  p-10 rounded-xl  hover:shadow-sky-700/30 hover:shadow-md transition-all ease-linear duration-300 hover:scale-[1.01]"
              >
                ...
                <div className="flex flex-col w-full justify-center items-center gap-2 mt-4 flex-wrap">
                  ...
                  <Link
                    className="text-xs md:text-sm text-gray-400 hover:text-gray-300 transition-all"
                    to="https://www.youtube.com/watch?v=r6mNf4cIfPQ&t=11s">
                    More
                  </Link>
                </div>
              </m.div>
